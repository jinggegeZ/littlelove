<template>
 <div>
    ...
    <el-table-column label="重要性" prop="star">
    <template slot-scope="scope"><el-rate v-model="scope.row.star"></el-rate></template>
    </el-table-column>
    <el-table-column label="发布时间" prop="date" width="250">
    ...
    <el-table-column label="操作" width="250">
      <template slot-scope="scope">
        ...
        <el-button size="mini" type="success" @click="see(scope.$index, scope.row)">查看</el-button>
      </template>
    </el-table-column>
  </el-table>
  <el-pagination
  ...
  export default {
   ...
   methods: {
     handleEdit(index, row) {
      ...
      see(){
        this.$router.push({name:'see',query:{_id:this.obj._id}})
      },
